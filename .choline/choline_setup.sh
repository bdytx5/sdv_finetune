...
pip install aiofiles==23.2.1 || pip3 install aiofiles==23.2.1 -y
pip install aiohttp==3.9.1 || pip3 install aiohttp==3.9.1 -y
pip install aioprocessing==2.0.1 || pip3 install aioprocessing==2.0.1 -y
pip install aiosignal==1.3.1 || pip3 install aiosignal==1.3.1 -y
pip install altgraph==0.17.3 || pip3 install altgraph==0.17.3 -y
pip install analytics-python==1.2.9 || pip3 install analytics-python==1.2.9 -y
pip install annotated-types==0.6.0 || pip3 install annotated-types==0.6.0 -y
pip install anyio==3.7.1 || pip3 install anyio==3.7.1 -y
pip install appdirs==1.4.4 || pip3 install appdirs==1.4.4 -y
pip install appnope==0.1.3 || pip3 install appnope==0.1.3 -y
pip install argon2-cffi==23.1.0 || pip3 install argon2-cffi==23.1.0 -y
pip install argon2-cffi-bindings==21.2.0 || pip3 install argon2-cffi-bindings==21.2.0 -y
pip install arrow==1.3.0 || pip3 install arrow==1.3.0 -y
pip install asn1crypto==1.5.1 || pip3 install asn1crypto==1.5.1 -y
pip install asttokens==2.4.1 || pip3 install asttokens==2.4.1 -y
pip install astunparse==1.6.3 || pip3 install astunparse==1.6.3 -y
pip install async-lru==2.0.4 || pip3 install async-lru==2.0.4 -y
pip install async-timeout==4.0.3 || pip3 install async-timeout==4.0.3 -y
pip install attrs==23.1.0 || pip3 install attrs==23.1.0 -y
pip install awscli==1.29.62 || pip3 install awscli==1.29.62 -y
pip install awsgi==0.0.5 || pip3 install awsgi==0.0.5 -y
pip install Babel==2.13.1 || pip3 install Babel==2.13.1 -y
pip install backoff==2.2.1 || pip3 install backoff==2.2.1 -y
...
pip install black==23.12.1 || pip3 install black==23.12.1 -y
pip install bleach==6.1.0 || pip3 install bleach==6.1.0 -y
pip install blinker==1.6.2 || pip3 install blinker==1.6.2 -y
pip install blis==0.7.11 || pip3 install blis==0.7.11 -y
pip install blobfile==2.1.1 || pip3 install blobfile==2.1.1 -y
...
pip install botocore==1.31.62 || pip3 install botocore==1.31.62 -y
pip install Brotli==1.1.0 || pip3 install Brotli==1.1.0 -y
...
pip install catalogue==2.0.10 || pip3 install catalogue==2.0.10 -y
...
pip install cfn-flip==1.3.0 || pip3 install cfn-flip==1.3.0 -y
pip install cfn-tools==0.1.6 || pip3 install cfn-tools==0.1.6 -y
...
pip install chevron==0.14.0 || pip3 install chevron==0.14.0 -y
pip install -e git+https://github.com/bdytx5/choline.git@4966c40ddf1194e5927d54f7c7b7babd2b810a14#egg=choline&subdirectory=choline_dev || pip3 install -e git+https://github.com/bdytx5/choline.git@4966c40ddf1194e5927d54f7c7b7babd2b810a14#egg=choline&subdirectory=choline_dev -y
pip install click==8.1.3 || pip3 install click==8.1.3 -y
pip install cloudevents==1.9.0 || pip3 install cloudevents==1.9.0 -y
pip install cloudpathlib==0.16.0 || pip3 install cloudpathlib==0.16.0 -y
pip install cloudpickle==2.2.1 || pip3 install cloudpickle==2.2.1 -y
pip install colorama==0.4.4 || pip3 install colorama==0.4.4 -y
pip install comm==0.2.0 || pip3 install comm==0.2.0 -y
...
pip install confection==0.1.4 || pip3 install confection==0.1.4 -y
pip install contextlib2==21.6.0 || pip3 install contextlib2==21.6.0 -y
...
pip install cymem==2.0.8 || pip3 install cymem==2.0.8 -y
pip install dataclasses-json==0.6.3 || pip3 install dataclasses-json==0.6.3 -y
pip install datasets==2.14.5 || pip3 install datasets==2.14.5 -y
pip install DateTime==5.1 || pip3 install DateTime==5.1 -y
pip install debugpy==1.8.0 || pip3 install debugpy==1.8.0 -y
pip install decorator==4.4.2 || pip3 install decorator==4.4.2 -y
pip install defusedxml==0.7.1 || pip3 install defusedxml==0.7.1 -y
pip install Deprecated==1.2.14 || pip3 install Deprecated==1.2.14 -y
pip install deprecation==2.1.0 || pip3 install deprecation==2.1.0 -y
pip install dill==0.3.7 || pip3 install dill==0.3.7 -y
pip install distro==1.8.0 || pip3 install distro==1.8.0 -y
...
pip install docstring-parser==0.15 || pip3 install docstring-parser==0.15 -y
pip install docutils==0.16 || pip3 install docutils==0.16 -y
pip install einops==0.7.0 || pip3 install einops==0.7.0 -y
pip install # Editable install with no version control (evals==1.0.3.post1) || pip3 install # Editable install with no version control (evals==1.0.3.post1) -y
pip install -e /Users/brettyoung/Desktop/dev/tutorials/mixtral/evals || pip3 install -e /Users/brettyoung/Desktop/dev/tutorials/mixtral/evals -y
pip install exceptiongroup==1.1.2 || pip3 install exceptiongroup==1.1.2 -y
pip install executing==2.0.1 || pip3 install executing==2.0.1 -y
pip install faiss-cpu==1.7.4 || pip3 install faiss-cpu==1.7.4 -y
pip install Farama-Notifications==0.0.4 || pip3 install Farama-Notifications==0.0.4 -y
pip install fastjsonschema==2.19.0 || pip3 install fastjsonschema==2.19.0 -y
...
pip install fqdn==1.5.1 || pip3 install fqdn==1.5.1 -y
...
pip install google-cloud-aiplatform==1.38.1 || pip3 install google-cloud-aiplatform==1.38.1 -y
pip install google-cloud-bigquery==3.14.1 || pip3 install google-cloud-bigquery==3.14.1 -y
pip install google-cloud-billing==1.11.5 || pip3 install google-cloud-billing==1.11.5 -y
pip install google-cloud-compute==1.14.1 || pip3 install google-cloud-compute==1.14.1 -y
...
pip install google-cloud-resource-manager==1.11.0 || pip3 install google-cloud-resource-manager==1.11.0 -y
...
pip install gql==3.5.0 || pip3 install gql==3.5.0 -y
pip install graphql-core==3.2.3 || pip3 install graphql-core==3.2.3 -y
pip install greenlet==3.0.3 || pip3 install greenlet==3.0.3 -y
pip install grpc-google-iam-v1==0.12.6 || pip3 install grpc-google-iam-v1==0.12.6 -y
...
pip install gym==0.26.2 || pip3 install gym==0.26.2 -y
pip install gym-notices==0.0.8 || pip3 install gym-notices==0.0.8 -y
pip install gymnasium==0.29.1 || pip3 install gymnasium==0.29.1 -y
pip install h11==0.14.0 || pip3 install h11==0.14.0 -y
pip install h5py==3.9.0 || pip3 install h5py==3.9.0 -y
pip install httpcore==1.0.2 || pip3 install httpcore==1.0.2 -y
pip install httplib2==0.22.0 || pip3 install httplib2==0.22.0 -y
pip install httptools==0.6.0 || pip3 install httptools==0.6.0 -y
pip install httpx==0.25.2 || pip3 install httpx==0.25.2 -y
...
pip install importlib-metadata==6.8.0 || pip3 install importlib-metadata==6.8.0 -y
pip install iniconfig==2.0.0 || pip3 install iniconfig==2.0.0 -y
pip install install==1.3.5 || pip3 install install==1.3.5 -y
pip install ipykernel==6.27.1 || pip3 install ipykernel==6.27.1 -y
pip install ipynbname==2023.2.0.0 || pip3 install ipynbname==2023.2.0.0 -y
pip install ipython==8.18.1 || pip3 install ipython==8.18.1 -y
pip install ipywidgets==8.1.1 || pip3 install ipywidgets==8.1.1 -y
pip install isoduration==20.11.0 || pip3 install isoduration==20.11.0 -y
pip install itsdangerous==2.1.2 || pip3 install itsdangerous==2.1.2 -y
pip install janus==1.0.0 || pip3 install janus==1.0.0 -y
pip install jaraco.classes==3.3.0 || pip3 install jaraco.classes==3.3.0 -y
pip install jedi==0.19.1 || pip3 install jedi==0.19.1 -y
pip install Jinja2==3.1.2 || pip3 install Jinja2==3.1.2 -y
pip install jiwer==3.0.3 || pip3 install jiwer==3.0.3 -y
pip install jmespath==1.0.1 || pip3 install jmespath==1.0.1 -y
pip install joblib==1.3.1 || pip3 install joblib==1.3.1 -y
pip install json5==0.9.14 || pip3 install json5==0.9.14 -y
pip install jsonpatch==1.33 || pip3 install jsonpatch==1.33 -y
pip install jsonpointer==2.1 || pip3 install jsonpointer==2.1 -y
pip install jsonschema==4.20.0 || pip3 install jsonschema==4.20.0 -y
pip install jsonschema-specifications==2023.11.2 || pip3 install jsonschema-specifications==2023.11.2 -y
pip install jupyter==1.0.0 || pip3 install jupyter==1.0.0 -y
pip install jupyter-console==6.6.3 || pip3 install jupyter-console==6.6.3 -y
pip install jupyter-events==0.9.0 || pip3 install jupyter-events==0.9.0 -y
pip install jupyter-lsp==2.2.1 || pip3 install jupyter-lsp==2.2.1 -y
pip install jupyter_client==8.6.0 || pip3 install jupyter_client==8.6.0 -y
pip install jupyter_core==5.5.0 || pip3 install jupyter_core==5.5.0 -y
pip install jupyter_server==2.12.1 || pip3 install jupyter_server==2.12.1 -y
pip install jupyter_server_terminals==0.4.4 || pip3 install jupyter_server_terminals==0.4.4 -y
pip install jupyterlab==4.0.9 || pip3 install jupyterlab==4.0.9 -y
pip install jupyterlab-widgets==3.0.9 || pip3 install jupyterlab-widgets==3.0.9 -y
pip install jupyterlab_pygments==0.3.0 || pip3 install jupyterlab_pygments==0.3.0 -y
pip install jupyterlab_server==2.25.2 || pip3 install jupyterlab_server==2.25.2 -y
pip install keras==2.13.1rc0 || pip3 install keras==2.13.1rc0 -y
pip install keyboard==0.13.5 || pip3 install keyboard==0.13.5 -y
pip install keyring==24.2.0 || pip3 install keyring==24.2.0 -y
pip install kiwisolver==1.4.4 || pip3 install kiwisolver==1.4.4 -y
pip install langchain==0.0.348 || pip3 install langchain==0.0.348 -y
pip install langchain-core==0.0.12 || pip3 install langchain-core==0.0.12 -y
pip install langcodes==3.3.0 || pip3 install langcodes==3.3.0 -y
pip install langdetect==1.0.9 || pip3 install langdetect==1.0.9 -y
pip install langsmith==0.0.69 || pip3 install langsmith==0.0.69 -y
pip install libclang==16.0.0 || pip3 install libclang==16.0.0 -y
pip install llama-index==0.9.34 || pip3 install llama-index==0.9.34 -y
pip install llvmlite==0.41.1 || pip3 install llvmlite==0.41.1 -y
pip install lxml==4.9.3 || pip3 install lxml==4.9.3 -y
pip install lz4==4.3.2 || pip3 install lz4==4.3.2 -y
pip install macholib==1.16.2 || pip3 install macholib==1.16.2 -y
pip install Markdown==3.4.3 || pip3 install Markdown==3.4.3 -y
pip install markdown-it-py==3.0.0 || pip3 install markdown-it-py==3.0.0 -y
pip install MarkupSafe==2.1.3 || pip3 install MarkupSafe==2.1.3 -y
pip install marshmallow==3.20.1 || pip3 install marshmallow==3.20.1 -y
pip install matplotlib==3.7.2 || pip3 install matplotlib==3.7.2 -y
pip install matplotlib-inline==0.1.6 || pip3 install matplotlib-inline==0.1.6 -y
pip install mdurl==0.1.2 || pip3 install mdurl==0.1.2 -y
pip install mistune==3.0.2 || pip3 install mistune==3.0.2 -y
pip install mock==5.1.0 || pip3 install mock==5.1.0 -y
pip install more-itertools==10.1.0 || pip3 install more-itertools==10.1.0 -y
...
pip install murmurhash==1.0.10 || pip3 install murmurhash==1.0.10 -y
pip install mutagen==1.47.0 || pip3 install mutagen==1.47.0 -y
pip install mypy==1.7.1 || pip3 install mypy==1.7.1 -y
pip install mypy-extensions==1.0.0 || pip3 install mypy-extensions==1.0.0 -y
pip install nbclient==0.9.0 || pip3 install nbclient==0.9.0 -y
pip install nbconvert==7.12.0 || pip3 install nbconvert==7.12.0 -y
pip install nbformat==5.9.2 || pip3 install nbformat==5.9.2 -y
pip install nest-asyncio==1.5.8 || pip3 install nest-asyncio==1.5.8 -y
pip install networkx==3.1 || pip3 install networkx==3.1 -y
pip install nh3==0.2.14 || pip3 install nh3==0.2.14 -y
pip install nltk==3.8.1 || pip3 install nltk==3.8.1 -y
pip install notebook==7.0.6 || pip3 install notebook==7.0.6 -y
pip install notebook_shim==0.2.3 || pip3 install notebook_shim==0.2.3 -y
pip install numba==0.58.1 || pip3 install numba==0.58.1 -y
pip install numexpr==2.8.7 || pip3 install numexpr==2.8.7 -y
pip install numpy==1.25.0 || pip3 install numpy==1.25.0 -y
pip install oauthlib==3.2.2 || pip3 install oauthlib==3.2.2 -y
pip install objgraph==3.6.0 || pip3 install objgraph==3.6.0 -y
pip install ollama==0.1.6 || pip3 install ollama==0.1.6 -y
pip install onnx==1.14.0 || pip3 install onnx==1.14.0 -y
pip install onnx-tf==1.10.0 || pip3 install onnx-tf==1.10.0 -y
pip install openai==1.12.0 || pip3 install openai==1.12.0 -y
...
pip install overrides==7.4.0 || pip3 install overrides==7.4.0 -y
pip install packaging==23.2 || pip3 install packaging==23.2 -y
pip install pafy==0.5.5 || pip3 install pafy==0.5.5 -y
pip install pandas==2.0.3 || pip3 install pandas==2.0.3 -y
pip install pandocfilters==1.5.0 || pip3 install pandocfilters==1.5.0 -y
pip install paramiko==3.3.1 || pip3 install paramiko==3.3.1 -y
pip install parso==0.8.3 || pip3 install parso==0.8.3 -y
pip install pathspec==0.12.1 || pip3 install pathspec==0.12.1 -y
pip install pathtools==0.1.2 || pip3 install pathtools==0.1.2 -y
pip install patsy==0.5.4 || pip3 install patsy==0.5.4 -y
pip install pexpect==4.9.0 || pip3 install pexpect==4.9.0 -y
pip install Pillow==10.1.0 || pip3 install Pillow==10.1.0 -y
pip install pkginfo==1.9.6 || pip3 install pkginfo==1.9.6 -y
pip install platformdirs==3.11.0 || pip3 install platformdirs==3.11.0 -y
...
pip install polars==0.20.13 || pip3 install polars==0.20.13 -y
pip install portalocker==2.8.2 || pip3 install portalocker==2.8.2 -y
pip install praw==7.7.1 || pip3 install praw==7.7.1 -y
pip install prawcore==2.4.0 || pip3 install prawcore==2.4.0 -y
pip install preshed==3.0.9 || pip3 install preshed==3.0.9 -y
pip install proglog==0.1.10 || pip3 install proglog==0.1.10 -y
pip install prometheus-client==0.19.0 || pip3 install prometheus-client==0.19.0 -y
pip install prompt-toolkit==3.0.41 || pip3 install prompt-toolkit==3.0.41 -y
...
pip install ptyprocess==0.7.0 || pip3 install ptyprocess==0.7.0 -y
pip install pure-eval==0.2.2 || pip3 install pure-eval==0.2.2 -y
pip install py-cpuinfo==9.0.0 || pip3 install py-cpuinfo==9.0.0 -y
pip install pyarrow==15.0.0 || pip3 install pyarrow==15.0.0 -y
...
pip install pycryptodomex==3.19.0 || pip3 install pycryptodomex==3.19.0 -y
pip install pydantic==2.5.2 || pip3 install pydantic==2.5.2 -y
pip install pydantic_core==2.14.5 || pip3 install pydantic_core==2.14.5 -y
pip install pydub==0.25.1 || pip3 install pydub==0.25.1 -y
pip install pygame==2.5.2 || pip3 install pygame==2.5.2 -y
pip install pyglet==2.0.14 || pip3 install pyglet==2.0.14 -y
pip install Pygments==2.16.1 || pip3 install Pygments==2.16.1 -y
...
pip install pynndescent==0.5.11 || pip3 install pynndescent==0.5.11 -y
pip install pynput==1.7.6 || pip3 install pynput==1.7.6 -y
...
pip install PyPDF2==3.0.1 || pip3 install PyPDF2==3.0.1 -y
pip install PyQt5-sip==12.11.0 || pip3 install PyQt5-sip==12.11.0 -y
pip install pyserial==3.5 || pip3 install pyserial==3.5 -y
...
pip install pytest==7.4.3 || pip3 install pytest==7.4.3 -y
pip install pytest-asyncio==0.21.1 || pip3 install pytest-asyncio==0.21.1 -y
...
pip install python-json-logger==2.0.7 || pip3 install python-json-logger==2.0.7 -y
...
pip install pyzmq==25.1.2 || pip3 install pyzmq==25.1.2 -y
pip install pyzstd==0.15.9 || pip3 install pyzstd==0.15.9 -y
pip install qtconsole==5.5.1 || pip3 install qtconsole==5.5.1 -y
pip install QtPy==2.4.1 || pip3 install QtPy==2.4.1 -y
pip install rapidfuzz==3.5.2 || pip3 install rapidfuzz==3.5.2 -y
pip install readme-renderer==42.0 || pip3 install readme-renderer==42.0 -y
pip install referencing==0.32.0 || pip3 install referencing==0.32.0 -y
...
pip install rfc3339-validator==0.1.4 || pip3 install rfc3339-validator==0.1.4 -y
pip install rfc3986==2.0.0 || pip3 install rfc3986==2.0.0 -y
pip install rfc3986-validator==0.1.1 || pip3 install rfc3986-validator==0.1.1 -y
pip install rich==13.7.0 || pip3 install rich==13.7.0 -y
pip install roboflow==1.1.2 || pip3 install roboflow==1.1.2 -y
pip install rpds-py==0.13.2 || pip3 install rpds-py==0.13.2 -y
pip install rsa==4.7.2 || pip3 install rsa==4.7.2 -y
...
pip install s3transfer==0.6.2 || pip3 install s3transfer==0.6.2 -y
pip install sacrebleu==2.3.3 || pip3 install sacrebleu==2.3.3 -y
pip install safetensors==0.3.1 || pip3 install safetensors==0.3.1 -y
pip install sahi==0.11.14 || pip3 install sahi==0.11.14 -y
pip install schema==0.7.5 || pip3 install schema==0.7.5 -y
...
pip install Send2Trash==1.8.2 || pip3 install Send2Trash==1.8.2 -y
...
pip install smart-open==6.4.0 || pip3 install smart-open==6.4.0 -y
pip install smmap==5.0.0 || pip3 install smmap==5.0.0 -y
pip install sniffio==1.3.0 || pip3 install sniffio==1.3.0 -y
pip install snowflake-connector-python==3.6.0 || pip3 install snowflake-connector-python==3.6.0 -y
...
pip install spacy==3.7.2 || pip3 install spacy==3.7.2 -y
pip install spacy-legacy==3.0.12 || pip3 install spacy-legacy==3.0.12 -y
pip install spacy-loggers==1.0.5 || pip3 install spacy-loggers==1.0.5 -y
pip install spacy-universal-sentence-encoder==0.4.6 || pip3 install spacy-universal-sentence-encoder==0.4.6 -y
pip install spotml==0.0.11 || pip3 install spotml==0.0.11 -y
pip install SQLAlchemy==2.0.23 || pip3 install SQLAlchemy==2.0.23 -y
pip install srsly==2.4.8 || pip3 install srsly==2.4.8 -y
pip install stack-data==0.6.3 || pip3 install stack-data==0.6.3 -y
pip install statsmodels==0.14.0 || pip3 install statsmodels==0.14.0 -y
pip install supervision==0.13.0 || pip3 install supervision==0.13.0 -y
pip install sympy==1.12 || pip3 install sympy==1.12 -y
pip install tabulate==0.9.0 || pip3 install tabulate==0.9.0 -y
pip install tenacity==8.2.3 || pip3 install tenacity==8.2.3 -y
...
pip install tensorflow-hub==0.15.0 || pip3 install tensorflow-hub==0.15.0 -y
...
pip install terminado==0.18.0 || pip3 install terminado==0.18.0 -y
pip install terminaltables==3.1.10 || pip3 install terminaltables==3.1.10 -y
pip install thinc==8.2.1 || pip3 install thinc==8.2.1 -y
...
pip install tinycss2==1.2.1 || pip3 install tinycss2==1.2.1 -y
...
pip install tomli==2.0.1 || pip3 install tomli==2.0.1 -y
pip install tomlkit==0.12.3 || pip3 install tomlkit==0.12.3 -y
...
pip install torch==2.1.0 || pip3 install torch==2.1.0 -y
pip install torchvision==0.16.0 || pip3 install torchvision==0.16.0 -y
pip install tornado==6.4 || pip3 install tornado==6.4 -y
...
pip install traitlets==5.14.0 || pip3 install traitlets==5.14.0 -y
...
pip install trl==0.7.2 || pip3 install trl==0.7.2 -y
pip install twine==4.0.2 || pip3 install twine==4.0.2 -y
pip install typeguard==4.1.5 || pip3 install typeguard==4.1.5 -y
pip install typer==0.9.0 || pip3 install typer==0.9.0 -y
pip install types-python-dateutil==2.8.19.14 || pip3 install types-python-dateutil==2.8.19.14 -y
pip install types-PyYAML==6.0.12.12 || pip3 install types-PyYAML==6.0.12.12 -y
pip install typing-inspect==0.9.0 || pip3 install typing-inspect==0.9.0 -y
pip install typing_extensions==4.8.0 || pip3 install typing_extensions==4.8.0 -y
pip install tyro==0.5.10 || pip3 install tyro==0.5.10 -y
pip install tzdata==2023.3 || pip3 install tzdata==2023.3 -y
pip install tzlocal==5.1 || pip3 install tzlocal==5.1 -y
pip install ultralytics==8.0.153 || pip3 install ultralytics==8.0.153 -y
pip install umap-learn==0.5.5 || pip3 install umap-learn==0.5.5 -y
pip install update-checker==0.18.0 || pip3 install update-checker==0.18.0 -y
pip install uri-template==1.3.0 || pip3 install uri-template==1.3.0 -y
...
pip install vertexai==0.0.1 || pip3 install vertexai==0.0.1 -y
pip install wandb==0.16.2 || pip3 install wandb==0.16.2 -y
pip install wasabi==1.1.2 || pip3 install wasabi==1.1.2 -y
pip install watchdog==3.0.0 || pip3 install watchdog==3.0.0 -y
pip install wcwidth==0.2.12 || pip3 install wcwidth==0.2.12 -y
pip install weasel==0.3.4 || pip3 install weasel==0.3.4 -y
pip install weave==0.34.0 || pip3 install weave==0.34.0 -y
pip install webcolors==1.13 || pip3 install webcolors==1.13 -y
pip install webencodings==0.5.1 || pip3 install webencodings==0.5.1 -y
pip install websocket-client==1.7.0 || pip3 install websocket-client==1.7.0 -y
...
pip install widgetsnbextension==4.0.9 || pip3 install widgetsnbextension==4.0.9 -y
pip install wrapt==1.15.0 || pip3 install wrapt==1.15.0 -y
pip install wsproto==1.2.0 || pip3 install wsproto==1.2.0 -y
pip install XlsxWriter==3.2.0 || pip3 install XlsxWriter==3.2.0 -y
...
pip install yt-dlp==2023.10.13 || pip3 install yt-dlp==2023.10.13 -y
pip install zipp==3.17.0 || pip3 install zipp==3.17.0 -y
